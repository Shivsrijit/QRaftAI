...
VedaAI is an AI powered assessment generation platform built for educators to compile curriculum aligned question papers and export them as formatted, print ready PDFs.
...
* **Clean Glassmorphic Design**: A clean interface boasting modern typography, subtle micro animations, and a polished dark/light mode toggle.
